...
public class GuardarUsuariosUbicaciones extends Activity {
    String km = "";
    String cod_empresa = "";
    String cod_sucursal = "";
    String tip_vehiculo = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // guardar.setVisibility(View.INVISIBLE);
        ...
        mProgressDialog= new ProgressDialog(GuardarUsuariosUbicaciones.this);
    ...
    class GuardarMovimiento extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            if(cod_proceso.trim().equals("24")){
                String url2 = "http://" + ip + "/guardarMovimientoservireencauche.php";

                List<NameValuePair> params2 = new ArrayList<NameValuePair>();

                params2.add(new BasicNameValuePair("sFecha",fecha));
                params2.add(new BasicNameValuePair("sUbicacion", cod_ubicacion));
                params2.add(new BasicNameValuePair("sHoraInicio", horaInicio));
                params2.add(new BasicNameValuePair("sHoraFin", horaFin));
                params2.add(new BasicNameValuePair("sParametro", "traTurnosUbicaciones"));
                ...
                params2.add(new BasicNameValuePair("sTiempo",tiempo));
                params2.add(new BasicNameValuePair("sUsuario", usuario));
                params2.add(new BasicNameValuePair("sHoraInicio", horaInicio));
                params2.add(new BasicNameValuePair("sHoraFin", horaFin));
                params2.add(new BasicNameValuePair("sParametro", "traTurnosUsuarios"));
        ...
        protected void onPostExecute(String file_url) {
            DataBaseHelper dataBaseHelper = new DataBaseHelper(GuardarUsuariosUbicaciones.this);
            try {
            ...
            new AlertDialog.Builder(GuardarUsuariosUbicaciones.this)
                    .setTitle("ATENCION")
