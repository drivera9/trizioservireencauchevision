...
public class MarcarOperarioRombo extends Activity {
    String empresa = "";
    String sucursal = "";
    String conexion = "";
    String ip = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marcar_operario_opciones);
        ...
        try {
            ...
            gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View v,
                    ...
                    Intent i = new Intent(MarcarOperarioRombo.this,MarcarOperarioDetalle.class);
