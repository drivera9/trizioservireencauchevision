...
public class Recepcion extends AppCompatActivity {
    ...
    public void camara(View v) {
        try{
            ActivityCompat.requestPermissions(Recepcion.this,
...
public void uploadImage(Bitmap b) {
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new GetTokenTask(Recepcion.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Recepcion.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
